...
public class CalculatorMethods
{
    ...
    {
        //Fix the line below- UPDATE works now
        return a - b;
    }
    ...
    public static void main(String[] args)
    {
        ...
        //It takes two input parameters which are 5 and 7 her.
        ...
        //because the subtract() method is incomplete. Fix it!- UPDATE works now
        ...
        //print statements to test that ir works right.
        System.out.println("6 divide by 3 equals " + divide(6,3));
        System.out.println("4 divide by 1 equals " + divide(4, 1));
    }
